...
- [8 x MI300X](https://github.com/sgl-project/sglang/blob/main/docs/platforms/amd_gpu.md#running-deepseek-v3)
...
- [4 x Atlas 800I A3 (int8)](https://github.com/sgl-project/sglang/blob/main/docs/hardware-platforms/ascend-npus/DeepSeek%20Examples.md#running-deepseek-with-pd-disaggregation-on-4-x-atlas-800i-a3)
