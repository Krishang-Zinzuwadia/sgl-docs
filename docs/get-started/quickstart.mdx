...
<Note>
For other platforms, see the dedicated guides for [AMD GPUs](https://github.com/sgl-project/sglang/blob/main/docs/platforms/amd_gpu.md), [Intel Xeon CPUs](../hardware-platforms/cpu-server), [Google TPUs](../hardware-platforms/tpu), [NVIDIA Jetson](../hardware-platforms/nvidia), [Ascend NPUs](https://github.com/sgl-project/sglang/blob/main/docs/hardware-platforms/ascend-npus/SGLang%20installation%20with%20NPUs%20support.md), and [Intel XPU](../hardware-platforms/xpu).
</Note>
