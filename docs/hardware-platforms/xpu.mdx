...
<Tabs>
    ...
    <Tab title="Source">
        ...
        <Steps>
            <Step title="Creation & Activation">
            ...
            <Step title="Install PyTorch and Dependencies">
            ...
            <Step title="Configure Build File">
...
Additionally, the requests can be formed with [OpenAI Completions API](../basic-usage/open-api-completions.mdx) and sent via the command line (e.g. using `curl`) or via your own script.
